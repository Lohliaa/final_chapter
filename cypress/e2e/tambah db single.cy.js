context('Tambah Properti Single', () => {
  ...
  it('Tambah Data', () => {
    ...
    cy.get('label:contains("Material") + input').type('YY25');
    ...
    cy.get('label:contains("TRM B") + input').type('SOLDER0');
    cy.get('label:contains("Acc bag b1") + input').type('Z092-1153-15');
    cy.get('label:contains("Acc bag b2") + input').type('-');
    cy.get('label:contains("TBE B") + input').type('0097-3358-00');
    cy.get('label:contains("TRM A") + input').type('0411-1697-20');
    cy.get('label:contains("Acc bag a1") + input').type('0100-6923-17');
    cy.get('label:contains("Acc bag a2") + input').type('-');
    cy.get('label:contains("TBE A") + input').type('0097-3358-00');
