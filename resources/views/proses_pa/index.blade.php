...
<body>
    <div class="card shadow mt-3">
        <div class="card-header py-6 mb-5">
            <h2 class="m-0 font-weight-bold text-primary" style="text-align: center">PROSES AREA PREPARATION</h2>
        </div>
                ...
                <table class="table table-bordered" style="width: 200%;" id="proses_paTableBody">
                    ...
                    <tbody>
                        ...
                        <tr id="tr_{{ $data->id }}">
                            ...
                            <td>{{$no++}}</td>
                            <td>{{ $data->area_preparation->month }}</td>
                            <td>{{ $data->area_preparation->kav }}</td>
                            <td>{{ $data->area_preparation->bagian }}</td>
                            <td>{{ $data->area_preparation->area_store }}</td>
                            <td>{{ $data->area_preparation->material }}</td>
                            ...
                            <td>{{ $data->tbe_a }}</td>
                            <td>{{ $data->area_preparation->total_qty }}</td>
